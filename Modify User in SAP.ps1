...
$headers.Add("SOAPAction", "urn:sap-com:document:sap:soap:functions:mc-style:_-KRH_-USID_WS_MOD_USER_IN_SAP:_-krh_-usidWsModUserInSapRequest")
...
$response = $response.Envelope.Body.'_-krh_-usidWsModUserInSapResponse'.EvAcknowledge
$Global:response = $Response{\rtf1}